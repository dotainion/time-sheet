        ...
        <div ref={landingRef} className="float-center max-size">
            <div className="flex float-center" style={{minWidth:"800px"}}>
                <div className="max-size pad">
                    ...
                    <p>
                        Content is a powerfule tool for scalling your business adn fast. But without a long-term plan, even the greatest content in the world won't be enough. With content strategy services from Scribly, you get the best of both worlds.
                    </p>
                </div>
                <div className="max-size pad">
