...
export const InputTextarea = ({inputRef, label, resize, placeholder, labelFixed, type, disabled, hidden, border, borderColor, error, errorReset, titleCase}) =>{
    ...
    return(
        ...
        >
            ...
            <textarea
                ...
                style={{border:error && "1px solid red", resize:!resize && "none"}}
                type={type}
            />
            <div
